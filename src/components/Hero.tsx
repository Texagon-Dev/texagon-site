    ...
    <div className="flex flex-row space-x-12 w-full h-full">
      <div className="flex flex-col space-y-6 w-full h-full">
        ...
        <p className="text-xl w-5/6 text-white/50">
          ...
          development services with Texagon, serving clients with top-tier web,
          mobile, and desktop solutions worldwide.
        </p>
      ...
      <div className="flex flex-col w-full h-full relative opacity-30">
