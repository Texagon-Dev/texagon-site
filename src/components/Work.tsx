    ...
    return (
        <div className="flex flex-col w-full h-full font-secondary">
            <div className='grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 p-5'>
                {work.map((item) => (
                    <div className='flex flex-col bg-gray-100/10 hover:bg-gray-100/20 transition-all ease-linear p-3 rounded-xl'>
                        <div className='flex flex-col justify-center items-center w-full rounded-xl'>
                            ...
                            <div className='flex flex-col mt-5 h-full'>
                                <h1 className='text-2xl text-center font-bold text-white uppercase tracking-wider'>{item.title}</h1>
                                <div className='flex flex-wrap flex-row justify-center mt-5'>
                                    {item.techStack.map((tech) => (
                                        <div className='flex flex-row justify-center items-center px-2 py-1 m-2 bg-gray-200/10 text-white rounded-full'>
