    ...
    return (
        <div className='flex space-y-12 flex-col bg-white/10 py-12 rounded-xl items-center justify-center w-full mt-16'>
            <div className='flex flex-col space-y-6 items-center justify-center'>
                <h3 className='text-6xl font-bold text-white'>Get in touch</h3>
                <p className='lg:w-2/4 md:w-3/4 w-full text-center text-lg text-white/60'>
            ...
            <div className='flex flex-col space-y-6 items-center justify-center w-full px-56'>
