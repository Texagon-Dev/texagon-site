...
export default function Home() {
  return (
    <>
      <main
        className={`bg-black md:flex flex-col hidden min-w-full ${spaceGrotesk.className}`}
      >
      ...
      <div className="flex md:hidden flex-col items-center justify-center w-full h-screen bg-black">
        <h1
          className={`text-md text-center uppercase tracking-wider font-bold text-white ${inter.className}`}
        >
          Mobile Version Under Development
        </h1>
        <a
          href="https://www.fiverr.com/saleemi2082"
          target="_blank"
